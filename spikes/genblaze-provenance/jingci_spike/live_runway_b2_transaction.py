...
def build_plan() -> dict[str, Any]:
    return {
        ...
        "fixture_result": "explicitly non-attestable; live result construction is not implemented",
    }
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.plan:
        parser.error("only --plan is available; combined live execution is disabled")
