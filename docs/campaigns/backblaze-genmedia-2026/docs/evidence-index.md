...
| B2 stores and serves the generated asset and canonical manifest | BLOCKED | Combined live transaction gate | Transport probe passed; meaningful Genblaze asset/manifest write and read-back remain unproven |
