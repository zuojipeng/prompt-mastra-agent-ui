...
| Reviewed source promotion has a no-overwrite, read-back-verified execution core | OFFLINE B2-SHAPED | `preview_source_promotion.py`, 5 injected-backend tests, plan output | No live CLI or approval schema exists; no source upload occurred |
